...
{
    /// <inheritdoc />
    public partial class AddOvertimeTransferAssetsProb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedHours = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    ...
                    Rate = table.Column<decimal>(type: "numeric(4,2)", precision: 4, scale: 2, nullable: false),
                    PayAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProbationEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Decision = table.Column<int>(type: "integer", nullable: false),
                    ExtensionMonths = table.Column<int>(type: "integer", nullable: true),
                    NewProbationEndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ManagerComments = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    HRComments = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProbationReviews_Employees_ReviewedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromDesignationId = table.Column<int>(type: "integer", nullable: false),
                    ToDesignationId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    OldBasicSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    NewBasicSalary = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ApprovedById = table.Column<int>(type: "integer", nullable: true),
                    ApprovedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RejectionReason = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransferPromotions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Departments_FromDepartmentId",
                        column: x => x.FromDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Departments_ToDepartmentId",
                        column: x => x.ToDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Designations_FromDesignationId",
                        column: x => x.FromDesignationId,
                        principalTable: "Designations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Designations_ToDesignationId",
                        column: x => x.ToDesignationId,
                        principalTable: "Designations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Employees_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Grades_FromGradeId",
                        column: x => x.FromGradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Grades_ToGradeId",
                        column: x => x.ToGradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Locations_FromLocationId",
                        column: x => x.FromLocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TransferPromotions_Locations_ToLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssetAssignments_Employees_AssignedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProbationReviews_ReviewedById",
                table: "ProbationReviews",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_ApprovedById",
                table: "TransferPromotions",
                column: "ApprovedById");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_EmployeeId",
                table: "TransferPromotions",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_FromDepartmentId",
                table: "TransferPromotions",
                column: "FromDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_FromDesignationId",
                table: "TransferPromotions",
                column: "FromDesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_FromGradeId",
                table: "TransferPromotions",
                column: "FromGradeId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_FromLocationId",
                table: "TransferPromotions",
                column: "FromLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_ToDepartmentId",
                table: "TransferPromotions",
                column: "ToDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_ToDesignationId",
                table: "TransferPromotions",
                column: "ToDesignationId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_ToGradeId",
                table: "TransferPromotions",
                column: "ToGradeId");

            migrationBuilder.CreateIndex(
                name: "IX_TransferPromotions_ToLocationId",
                table: "TransferPromotions",
                column: "ToLocationId");
        }

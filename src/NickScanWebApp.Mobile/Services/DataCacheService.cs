...
public class DataCacheService
{
    ...
    private readonly TimeSpan _containerListCacheDuration = TimeSpan.FromMinutes(5);
    private readonly TimeSpan _containerDetailsCacheDuration = TimeSpan.FromMinutes(10);
    private readonly TimeSpan _dashboardCacheDuration = TimeSpan.FromMinutes(1);
    private readonly TimeSpan _staticDataCacheDuration = TimeSpan.FromHours(1);

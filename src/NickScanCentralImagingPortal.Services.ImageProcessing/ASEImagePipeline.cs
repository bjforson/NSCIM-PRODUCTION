...
namespace NickScanCentralImagingPortal.Services.ImageProcessing
{
    public class ASEImagePipeline : IImagePipeline
    {
        ...
        public ASEImagePipeline(ILogger<ASEImagePipeline> logger, ApplicationDbContext context, IImageCacheService cacheService, IASEImageConverterService converterService)
        {
            _logger = logger;
            _context = context;

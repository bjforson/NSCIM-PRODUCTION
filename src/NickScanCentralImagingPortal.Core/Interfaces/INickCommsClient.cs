...
{
    /// <summary>
    /// HTTP client for the NickComms.Gateway service. Single sending authority for
    /// all email, SMS, and message-history queries used by NSCIS.
    /// </summary>
    public interface INickCommsClient
    {
        ...
        /// <summary>Pings the gateway health endpoint and returns true on 2xx.</summary>
    ...
    public class NickCommsHistoryQuery
    {
        ...
        public string? Channel { get; set; } // "sms" | "email" | null
